	...
	<script type="text/javascript">
		function fun1(){
			...
			for(var i = 0 ; i<jsonArray.length; ){
				...
				td.innerHTML="货物名称：    "+good1["name"]+"<br>"+"货物价格：    "+good1["price"]+"元"+"<br>货物id：    "+good1["id"]+"<br>日期：    "+good1["odate"];
				//将td添加到tr中
				tr.appendChild(td);
				//判断,是否还有下一个商品
				if(i <= jsonArray.length-1 ){
							...
							td2.innerHTML="货物名称：    "+good1["name"]+"<br>"+"货物价格：    "+good1["price"]+"元"+"<br>货物id：    "+good1["id"]+"<br>日期：    "+good1["odate"];
							//将td添加到tr中
							tr.appendChild(td2);
				}
				//tr添加到表格中
